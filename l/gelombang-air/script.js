...
import * as dat from '../../../sumber/three.js/examples/jsm/libs/lil-gui.module.min.js';
...
import { createCamera, createRenderer, runApp, updateLoadingProgressBar } from './src/core-utils.js';

// Other deps
// import HeightmapFragment from './src/shaders/heightmapFragment.glsl';
...
let app = {
  async initScene() {
    ...
    this.heightmapVariable = this.gpuCompute.addVariable( 'heightmap',
