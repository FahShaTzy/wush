...
import { OBJLoader } from '../../../sumber/three.js/examples/jsm/loaders/OBJLoader.js';
import {
    GodRaysFakeSunShader,
    GodRaysDepthMaskShader,
    GodRaysCombineShader,
    GodRaysGenerateShader
} from '../../../sumber/three.js/examples/jsm/shaders/GodRaysShader.js';
...
new OBJLoader().load( '../../sumber/three.js/examples/models/obj/tree.obj', function ( object ) {
...
sphere.scale.multiplyScalar( 20 );
scene.add( sphere );
...
function initPostprocessing( renderTargetWidth, renderTargetHeight ) {
    ...
    postprocessing.godrayCombineUniforms.fGodRayIntensity.value = 0.6;
...
function render() {
    ...
    sphere.position.z = orbitRadius * Math.sin( time ) - 100;
