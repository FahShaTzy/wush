...
function createObjects() {
	...
	textureLoader.load( '../../sumber/three.js/examples/textures/grid.png', function ( texture ) {
	...
	for ( let i = 0; i < numStones; i ++ ) {
		...
		createObject( stoneMass, stoneHalfExtents, pos, quat, createMaterial() );
	...
	const mountain = new THREE.Mesh( new ConvexGeometry( mountainPoints ), createMaterial() );
